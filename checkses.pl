...
say REPORT	' 		}';
say REPORT	' 		h1 {';
say REPORT	' 			text-align: center;';
say REPORT	' 			color: #00aced;';
say REPORT	' 		}';
say REPORT	'    </style>';
